...
public class Personne {
    ...
    public Personne(int id, String nom, String prenom, String email, int roleJava_client_id, LocalDate dateNaise, String pprofile, boolean is_banned, boolean is_verified) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
...
public Personne(String nom, String prenom, String email, String password) {
    ...
    public Personne(int id, String nom, String prenom, String email, LocalDate dateNaise, String pprofile, int roleJava_client_id) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
    ...
    public Personne(int id, String nom, String prenom, String email, String[] roles, String password, LocalDate dateNaise, Adresse adresse, String pprofile, boolean is_banned, int roleJava_client_id) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
    ...
    public Personne(int id, String nom, String prenom, String email, String[] roles, String password, LocalDate dateNaise, String pprofile, boolean is_banned, int roleJava_client_id) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
    ...
    public Personne(String nom, String prenom, String email, String[] roles, String password, LocalDate dateNaise, String pprofile, boolean is_banned, boolean is_verified) {
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
        this.roles = roles;

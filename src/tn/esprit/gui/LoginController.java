...
//                controller.setSessionId(sessionId);
                ...
                {
                     Parent page1 = FXMLLoader.load(getClass().getResource("UserProfile.fxml"));//to change with the gui de siwar
                Scene scene = new Scene(page1);
                FXMLLoader loader = new FXMLLoader(getClass().getResource("UserProfile.fxml"));;//to change with the gui de siwar
                Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
                //loader.setController(controller);
                //controller.setSessionId(sessionId);
